...
const STATIC_REWARDS: Reward[] = [
  ...
  { id: 'screen', family_id: 'static-family-1', title: '30 min de pantalla extra', cost: 10, emoji: '🎮' },
  { id: 'park', family_id: 'static-family-1', title: 'Tarde de parque', cost: 15, emoji: '🛝' },
  { id: 'movie', family_id: 'static-family-1', title: 'Elegir película familiar', cost: 20, emoji: '🍿' },
];
